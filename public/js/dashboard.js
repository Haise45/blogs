    ...
    auth.createUserWithEmailAndPassword(email, password)
        .then((userCredential) => {
            ...
            db.collection("user").doc(userUID).set({
                ...
                userUID: userUID,
                password: password,
                // Các thông tin người dùng khác có thể lưu
            })
            .then(() => {
...
// Lắng nghe sự kiện click trên liên kết "Sign up" trong form đăng nhập
document.querySelector('.login a[href="#signup"]').addEventListener('click', function(event) {
...
// Lắng nghe sự kiện click trên liên kết "Sign up" trong form đăng ký
document.querySelector('.signup a[href="#login"]').addEventListener('click', function(event) {
    event.preventDefault(); // Ngăn chặn hành động mặc định của thẻ a
